  ...
  <div class="container-fluid text-center">
    <div class="row content">
      <div class="col-sm-2 sidenav">
        <ul>
          <p><li class="home"><a href="#description">Description</a></li></p>
          <p><li class="home"><a href="#aim">Aim</a></li></p>
        </ul>
    </div>
   <div class="col-sm-8 text-left"> 
      <img src="../images/welcome.jpg" width="50%" height="30%">
...
<footer>
  <p>&copy Vanshi(7744) Priya(7743) Surbhi(7772)</p>
  <img src="../images/facebook.png" width="3%" height="3%">
  <img src="../images/twitter.png" width="3%" height="3%">
  <img src="../images/instagram.png" width="3%" height="3%">
</footer>
</body>
</html>
